...
/// call the delegate's ``MRSharingSessionDelegate/sharingSession:friendsDidUpdate:`` method.
...
/// Protocol an object must adopt to receive callbacks from``MRSharingSession``.
