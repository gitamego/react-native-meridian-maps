...
class OverlayMarkerFragment : MapFragment(), MapView.MarkerEventListener {
    ...
    private fun toggleColor(marker: Marker) {
        ...
        if (ctx != null) {
            ...
            run {
                // when selected, toggle Fill Color between original color, and R.color.overlay_red_stroke
                val currentFillColor = options.overlayFillColor
                var updatedFillColor: Int? = ContextCompat.getColor(ctx, R.color.overlay_red_fill)
            ...
            run {
                // when selected, toggle Edge Color between original color, and R.color.overlay_red_fill
                val currentEdgeColor = options.overlayColor
                var updatedEdgeColor: Int? = ContextCompat.getColor(ctx, R.color.overlay_red_fill)
    ...
    override fun markerForPlacemark(placemark: Placemark): Marker? {
        ...
        if (placemark.name.contains("EventSpace")) {
            ...
            if (ctx != null) {
                ...
                gm.overlayMarkerOptions.overlayColor = ContextCompat.getColor(ctx, R.color.overlay_green_stroke)
                gm.overlayMarkerOptions.overlayFillColor = ContextCompat.getColor(ctx, R.color.overlay_green_fill)
            }
    ...
    override fun onPlacemarksLoadFinish() {
        ...
        for (placemark in mapView.placemarks) {
            if (placemark.name.contains("Storage")) {
                ...
                val ctx: Context? = context?.applicationContext
                if (ctx != null) {
                    om.overlayMarkerOptions.overlayColor = ContextCompat.getColor(ctx, R.color.overlay_blue_stroke)
                    om.overlayMarkerOptions.overlayFillColor = ContextCompat.getColor(ctx, R.color.overlay_blue_fill)
                }
    ...
    override fun onMapRenderFinish() {
        ...
        if (c != null && ctx != null) {
            ...
            optionOpenPath.overlayColor = ContextCompat.getColor(ctx, R.color.overlay_purple_stroke)
            optionOpenPath.overlayFillColor = ContextCompat.getColor(ctx, R.color.overlay_purple_fill)
            ...
            optionsArrow.overlayColor = ContextCompat.getColor(ctx, R.color.overlay_purple_stroke)
            optionsArrow.overlayFillColor = ContextCompat.getColor(ctx, R.color.overlay_purple_fill)
            ...
            circleMarker.overlayMarkerOptions.overlayColor = ContextCompat.getColor(ctx, R.color.overlay_purple_stroke)
            circleMarker.overlayMarkerOptions.overlayFillColor = ContextCompat.getColor(ctx, R.color.overlay_purple_fill)
