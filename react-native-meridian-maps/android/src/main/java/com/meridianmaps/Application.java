...
public class Application extends android.app.Application {
  // Remove these static fields since they're no longer needed
  // public static EditorKey APP_KEY = MeridianApplication.getAPP_KEY();
  // public static EditorKey MAP_KEY = MeridianApplication.getMAP_KEY();
  // public static String EDITOR_TOKEN = MeridianApplication.getEDITOR_TOKEN();

  public static final String PLACEMARK_UID = "CASIO_UID";
  public static final String TAG_MAC = "";
  public static final String PROXIMITY_BEACON_MAC = "";
