...
public class Application extends android.app.Application {
    ...
    public static final String PROXIMITY_BEACON_MAC = ""; // mac address (without :'s) of one of your proximity beacons here
    ...
    public void onCreate() {
        ...
        // NOTE: Both android built-in fonts and custom fonts either created like below or from resources can be used.
    ...
    protected void attachBaseContext(Context base) {
        ...
        ACRA.init(this, new CoreConfigurationBuilder()
                ...
                .withLogcatArguments("-t","10000","-v","time")
                .withPluginConfigurations(
                        new MailSenderConfigurationBuilder()
                                .withMailTo("developers@meridianapps.com")
                                .build()
                )
        );
    }
